/**
 * AedSymbol — Official UAE Dirham currency symbol
 * Source: Central Bank of UAE (CBUAE), March 2025
 * Uses official SVG path — no Unicode required.
 * Scales to match surrounding font size.
 * Inherits color via `fill="currentColor"`.
 */
export function AedSymbol({ className = "" }) {
    return (
        <svg
