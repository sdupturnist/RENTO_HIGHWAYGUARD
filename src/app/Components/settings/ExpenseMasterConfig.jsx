...
export function ExpenseMasterConfig() {
    ...
    const handleSubmit = async () => {
        ...
        try {
            const url = editingType
                ? `/api/settings/master/expense/${editingType.id}`
                : "/api/settings/master/expense";
    ...
    const confirmDelete = async () => {
        if (!deleteId) return;
        try {
            const res = await fetch(`/api/settings/master/expense/${deleteId}`, {
                method: "DELETE",
            });
        ...
        <div className="space-y-4">
            <div className="flex justify-between items-center">
                ...
                <Dialog open={open} onOpenChange={(val) => {
                    ...
                    <DialogContent>
                        <DialogHeader>
                            <DialogTitle>{editingType ? "Edit Type" : "Add Expense Type"}</DialogTitle>
                            <DialogDescription>
                                Create categories for operational expenses (e.g., Fuel, Tolls, Misc).
                            </DialogDescription>
                        </DialogHeader>
                ...
                <AlertDialogContent>
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                            This action cannot be undone. This will permanently delete the expense type.
                        </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
