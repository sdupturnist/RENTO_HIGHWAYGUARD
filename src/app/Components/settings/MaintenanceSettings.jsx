...
export function MaintenanceSettings({ onDirtyStateChange }) {
    ...
    return (<Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                <Card>
                    <CardHeader>
                        <CardTitle>Maintenance Code Rules</CardTitle>
                        <CardDescription>Configure how maintenance request codes are generated.</CardDescription>
                    </CardHeader>
                    <CardContent className="space-y-4">
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <FormField control={form.control} name="prefix" render={({ field }) => (<FormItem>
                                    ...
                                    <FormDescription>e.g., MAINT</FormDescription>
                                    <FormMessage />
                                </FormItem>)}/>
                        ...
                        <div className="bg-muted p-4 rounded-md">
                            <p className="text-sm text-muted-foreground">Preview: <span className="font-mono font-medium text-foreground">{form.watch("prefix")}-{String(form.watch("startingNumber") || 0).padStart(Number(form.watch("padding") || 0), '0')}</span></p>
                        </div>
                    </CardContent>
                </Card>
